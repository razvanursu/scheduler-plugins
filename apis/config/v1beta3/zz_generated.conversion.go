...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*CustomNodeResourcesFitArgs)(nil), (*config.CustomNodeResourcesFitArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_NodeResourcesFitArgs_To_config_NodeResourcesFitArgs(a.(*CustomNodeResourcesFitArgs), b.(*config.CustomNodeResourcesFitArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.CustomNodeResourcesFitArgs)(nil), (*CustomNodeResourcesFitArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NodeResourcesFitArgs_To_v1beta3_NodeResourcesFitArgs(a.(*config.CustomNodeResourcesFitArgs), b.(*CustomNodeResourcesFitArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*CustomNodeAffinityArgs)(nil), (*config.CustomNodeAffinityArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_NodeAffinityArgs_To_config_NodeAffinityArgs(a.(*CustomNodeAffinityArgs), b.(*config.CustomNodeAffinityArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.CustomNodeAffinityArgs)(nil), (*CustomNodeAffinityArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NodeAffinityArgs_To_v1beta3_NodeAffinityArgs(a.(*config.CustomNodeAffinityArgs), b.(*CustomNodeAffinityArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta3_NodeResourcesFitArgs_To_config_NodeResourcesFitArgs(in *CustomNodeResourcesFitArgs, out *config.CustomNodeResourcesFitArgs, s conversion.Scope) error {
	...
	out.ScoringStrategy = (*apisconfig.ScoringStrategy)(unsafe.Pointer(in.ScoringStrategy))
	return nil
}

// Convert_v1beta3_NodeResourcesFitArgs_To_config_NodeResourcesFitArgs is an autogenerated conversion function.
func Convert_v1beta3_NodeResourcesFitArgs_To_config_NodeResourcesFitArgs(in *CustomNodeResourcesFitArgs, out *config.CustomNodeResourcesFitArgs, s conversion.Scope) error {
	return autoConvert_v1beta3_NodeResourcesFitArgs_To_config_NodeResourcesFitArgs(in, out, s)
}

func autoConvert_config_NodeResourcesFitArgs_To_v1beta3_NodeResourcesFitArgs(in *config.CustomNodeResourcesFitArgs, out *CustomNodeResourcesFitArgs, s conversion.Scope) error {
	out.IgnoredResources = *(*[]string)(unsafe.Pointer(&in.IgnoredResources))
	out.IgnoredResourceGroups = *(*[]string)(unsafe.Pointer(&in.IgnoredResourceGroups))
	out.ScoringStrategy = (*configv1beta3.ScoringStrategy)(unsafe.Pointer(in.ScoringStrategy))
	return nil
}

// Convert_config_NodeResourcesFitArgs_To_v1beta3_NodeResourcesFitArgs is an autogenerated conversion function.
func Convert_config_NodeResourcesFitArgs_To_v1beta3_NodeResourcesFitArgs(in *config.CustomNodeResourcesFitArgs, out *CustomNodeResourcesFitArgs, s conversion.Scope) error {
	return autoConvert_config_NodeResourcesFitArgs_To_v1beta3_NodeResourcesFitArgs(in, out, s)
}

func autoConvert_v1beta3_NodeAffinityArgs_To_config_NodeAffinityArgs(in *CustomNodeAffinityArgs, out *config.CustomNodeAffinityArgs, s conversion.Scope) error {
...
func Convert_v1beta3_NodeAffinityArgs_To_config_NodeAffinityArgs(in *CustomNodeAffinityArgs, out *config.CustomNodeAffinityArgs, s conversion.Scope) error {
	return autoConvert_v1beta3_NodeAffinityArgs_To_config_NodeAffinityArgs(in, out, s)
}

func autoConvert_config_NodeAffinityArgs_To_v1beta3_NodeAffinityArgs(in *config.CustomNodeAffinityArgs, out *CustomNodeAffinityArgs, s conversion.Scope) error {
	out.AddedAffinity = (*corev1.NodeAffinity)(unsafe.Pointer(in.AddedAffinity))
	return nil
}

// Convert_config_NodeAffinityArgs_To_v1beta3_NodeAffinityArgs is an autogenerated conversion function.
func Convert_config_NodeAffinityArgs_To_v1beta3_NodeAffinityArgs(in *config.CustomNodeAffinityArgs, out *CustomNodeAffinityArgs, s conversion.Scope) error {
